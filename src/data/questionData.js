const geographyAQuestionsArr = [
  ...
  },
  {
    ...
    type: "Checkbox",
    url:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSz7A2xQM2MB_gj5DKhZFTRn9Q8OqA3eBo_Q7oCLW5I7v4hd0KFkg",
    answer: [
      {
        title: "панда",
        isTrue: false,
  ...
  {
    title:
      "Определи страну по её характеристике: «Это карликовое государство с населением около 1 тыс. человек имеет свое правительство, свой банк, гвардию, законы, валюту и монарха. Сфера деятельности этого государства – весь мир».",
    type: "Radio",
    url:
      "https://moeobrazovanie.ru/data/prof_tests/test_272/exercise_4981/exercise_pic.jpg",
    answer: [
      {
        title: "Андорра",
        isTrue: false,
...
const biologyQuestionsArr = [
...

  {
    ...
    type: "Checkbox",
    answer: [
      { title: " клеточный центр ", isTrue: true, point: 0.5 },
...

  {
    ...
    type: "Radio",
    answer: [
      { title: "наружном ухе", isTrue: false, point: 0 },
...

  {
    ...
    type: "Select",
    answer: [
      { title: "адреналин", isTrue: false, point: 0 },
...

  {
    ...
    type: "Select",
    answer: [
      { title: "в пищеводе", isTrue: false, point: 0 },
...

  {
    ...
    type: "Checkbox",
    answer: [
      { title: "разрушение клеток", isTrue: true, point: 0.5 },
